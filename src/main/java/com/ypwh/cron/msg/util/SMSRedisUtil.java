...
public final class SMSRedisUtil {
	
	public static final Logger logger = LoggerFactory.getLogger(SMSRedisUtil.class);
    
    //Redis服务器IP
    private static String ADDR = Resources.getString("sms.redis.host");
    
    //Redis的端口号
    private static int PORT = Resources.getConfigAsInt("sms.redis.port");
    
    //Redis服务器IP
    private static String PASSWORD = Resources.getString("sms.redis.password");
